        ...
        (successResponse: any) => {
          ...
          listOfProjects.forEach((project) => {
            if(provinceProjectCount[project.Province] == null) {
              ...
              provinceProjectCount[project.Province] = provinceProjectCount[project.Province] + 1;
            }
          });
          ...
          canadajson.features.forEach((obj: any, index: any) => {
            if(provinceProjectCount[obj.properties.name] != null) {
              canadajson.features[index].properties.name = canadajson.features[index].properties.name + ' ( ' + provinceProjectCount[obj.properties.name] + ' ) ' 
            }
          });

          echarts.registerMap('abc', canadajson);
          this.mapChartOption = {
            toolbox: {
              show: true,
              //orient: 'vertical',
